...
/****** Object:  StoredProcedure [Import].[RecordType2Merge_Copy]    Script Date: 2/14/2017 2:00:35 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [Import].[RecordType2Merge_Copy]
...
MERGE StateSubmission.sdb.RecordType2_Copy AS Target
