...
/****** Object:  Table [SDB].[RecordType4_Copy]    Script Date: 2/14/2017 1:58:45 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [SDB].[RecordType4_Copy](
...
ALTER TABLE [SDB].[RecordType4_Copy] ADD  CONSTRAINT [DF_RecordType4_RowID_Copy]  DEFAULT (newid()) FOR [RowID]
GO

ALTER TABLE [SDB].[RecordType4_Copy] ADD  CONSTRAINT [DF_RecordType4_InsertDate_Copy]  DEFAULT (getdate()) FOR [InsertDate]
GO
