...
/****** Object:  StoredProcedure [Import].[RecordType3Merge]    Script Date: 2/1/2017 10:23:08 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [Import].[RecordType3Merge]
...
MERGE StateSubmission.sdb.RecordType3 AS Target
