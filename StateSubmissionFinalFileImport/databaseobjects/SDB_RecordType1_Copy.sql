...
/****** Object:  Table [SDB].[RecordType1_Copy]    Script Date: 2/14/2017 1:57:49 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [SDB].[RecordType1_Copy](
...
ALTER TABLE [SDB].[RecordType1_Copy] ADD  CONSTRAINT [DF_RecordType1_RowID_1_Copy]  DEFAULT (newid()) FOR [RowID]
GO

ALTER TABLE [SDB].[RecordType1_Copy] ADD  CONSTRAINT [DF_RecordType1_InsertDate_1_Copy]  DEFAULT (getdate()) FOR [InsertDate]
GO
