...
/****** Object:  Table [SDB].[RecordType8]    Script Date: 2/1/2017 9:50:21 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [SDB].[RecordType8] ADD  CONSTRAINT [DF_RecordType8_RowID]  DEFAULT (newid()) FOR [RowID]
GO

ALTER TABLE [SDB].[RecordType8] ADD  CONSTRAINT [DF_RecordType8_InsertDate]  DEFAULT (getdate()) FOR [InsertDate]
GO
