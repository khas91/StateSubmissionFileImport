...
/****** Object:  StoredProcedure [Import].[RecordType1Merge_Copy]    Script Date: 2/14/2017 2:00:20 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [Import].[RecordType1Merge_Copy]
...
MERGE StateSubmission.sdb.RecordType1_Copy AS Target
...
WHEN NOT MATCHED BY Target THEN
	INSERT (
		...
		[InsertDate],
		[FLEID],
		[DE1053-HIGHEST-ED-P1],
		[DE1054-HIGHEST-ED-P2],
		[DE1057-MILITARY-STATUS],
		[DE1058-SINGLE-PARENT],
		[DE1059-DISPLACED_HOMEMAKER],
		[DE1060-EX-OFFENDER],
		[DE1061-HOMELESS-RUNAWAY],
		[DE1062-EMP-BARRIER],
		[DE1063-MIGRANT-WORK],
		[DE1064-LVL-SCHOOL]) 
	Values (
		...
		@SubmissionDate,
		getDate()
		,Source.[FloridaEducationalId],
		[1053_Highest_Ed_Lvl_PG1],
		[1054_Highest_Ed_Lvl_PG2],
		[1057_Mil_Status],
		[1058_Single_Parent_Pregnant],
		[1059_Displaced_Homemaker],
		[1060_AGE_Ex_Offender],
		[1061_AGE_Homeless_Runaway],
		[1062_AGE_Emp_Barrier],
		[1063_AGE_Migrant_Worker],
		[1064_Lvl_Schooling_Achieved])
	OUTPUT $Action;
END
