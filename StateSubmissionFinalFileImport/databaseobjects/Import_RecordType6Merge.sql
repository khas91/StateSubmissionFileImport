...
/****** Object:  StoredProcedure [Import].[RecordType6Merge]    Script Date: 2/1/2017 10:25:52 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [Import].[RecordType6Merge]
...
MERGE StateSubmission.sdb.RecordType6 AS Target
