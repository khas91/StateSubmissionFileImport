...
/****** Object:  StoredProcedure [Import].[RecordType4Merge]    Script Date: 2/1/2017 10:23:57 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [Import].[RecordType4Merge]
...
MERGE StateSubmission.sdb.RecordType4 AS Target
