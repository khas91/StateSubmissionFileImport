...
/****** Object:  StoredProcedure [Import].[RecordType9Merge_Copy]    Script Date: 2/14/2017 2:03:18 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [Import].[RecordType9Merge_Copy]
...
MERGE StateSubmission.sdb.RecordType9_Copy AS Target
