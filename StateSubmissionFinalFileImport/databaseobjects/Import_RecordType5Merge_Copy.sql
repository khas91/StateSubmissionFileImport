...
/****** Object:  StoredProcedure [Import].[RecordType5Merge_Copy]    Script Date: 2/14/2017 2:02:18 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [Import].[RecordType5Merge_Copy]
...
MERGE StateSubmission.sdb.RecordType5_Copy  AS Target
