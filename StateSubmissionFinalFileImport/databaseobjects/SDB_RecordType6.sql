...
/****** Object:  Table [SDB].[RecordType6]    Script Date: 2/1/2017 9:50:02 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [SDB].[RecordType6] ADD  CONSTRAINT [DF_RecordType6_RowID_1]  DEFAULT (newid()) FOR [RowID]
GO

ALTER TABLE [SDB].[RecordType6] ADD  CONSTRAINT [DF_RecordType6_InsertDate_1]  DEFAULT (getdate()) FOR [InsertDate]
GO
